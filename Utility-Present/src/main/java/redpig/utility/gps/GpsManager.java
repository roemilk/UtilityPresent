...
public class GpsManager {
	...
	private double mLongitue = 0;

	public GpsManager(Context context, GpsInterface.onUpdateListener listener) {
	...
	LocationListener locationListener = new LocationListener() {
		...
		public void onLocationChanged(Location location) {
			...
			Log.i("GPS", "위도 : " + mLatitude + "  경도 : " + mLongitue);
			mListener.updateGpsInfo(mLatitude, mLongitue);
